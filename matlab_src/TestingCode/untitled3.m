...
outdir = 'New-Results-mod-sm2-comparison-correct+noise_2';
...
%[ load image
image_list = {'Lena.png','Barbara.png','Child.png'};
...
% i = 1;
    ...
    fn_full_gnd = fullfile(sprintf('Data/Testing/%s_gnd.png',image_list{i}(1:end-4)));
